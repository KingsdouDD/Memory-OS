...
- **稳定人物关系**：「用户有外婆」「姨妈是用户的姐姐」「外婆养了一只布偶猫」—— 关系一旦建立就是事实，不会因出现次数变
- **稳定人格特征**：「用户是 INFJ-A」「外婆疼用户」—— 不会随单次事件改变
- **长期习惯/偏好**：「外婆喜欢早起爬山」「外婆经常给猫买零食」—— 习惯本身是长期稳定的，不需要反复验证
- **明确表达的长期状态**：「我从小都喜欢…」「外婆一直这样…」「以我的经验…」

不适合生成 L3 的信息：

- **单次经历的具体内容**（放 L1）：「外婆帮用户按摩脚」「用户被蜜蜂蛰脸肿」

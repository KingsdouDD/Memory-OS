...
“我以前跟你外婆去香港，那个时候可快乐了，去了港岛，看了维多利亚港，去了山顶。”
...
- **稳定人物关系**：「老豆有外婆」「姨妈是老豆的姐姐」「外婆养了一只布偶哥哥」—— 关系一旦建立就是事实，不会因出现次数变
- **稳定人格特征**：「老豆是 INFJ-A」「外婆疼老豆」—— 不会随单次事件改变
- **长期习惯/偏好**：「外婆喜欢早起爬山」「外婆经常给小橘子买零食」—— 习惯本身是长期稳定的，不需要反复验证
- **明确表达的长期状态**：「我从小都喜欢…」「外婆一直这样…」「以我的经验…」

不适合生成 L3 的信息：

- **单次经历的具体内容**（放 L1）：「外婆帮老豆盘猪老二」「老豆被蜜蜂蛰脸肿」
- **单次情绪/感慨**（放 L1）：「那天真快乐」「童年好自在」
- **纯推断/情感评价**（不生成）：「老豆是个好人」（缺乏具体依据）
- **AI 自己说的话或假设**（不生成）
...
- 超出说明抽取过碎，需合并同类项（例如多条“姐姐陪我玩”合成 1 条，丢入 tags）

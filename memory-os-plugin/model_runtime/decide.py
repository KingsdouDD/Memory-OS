...
解决的问题：
  ...
  导致语义不重复但向量接近的记录被错误 SKIP。确认于 2026-09-10：
...
判断要点：
1. 时间、地点、人物、事件是否真正相同
2. 是否只是"提到同一类对象"但事件不同（两次同一地点但日期或同行人不同 → CREATE）
...
if __name__ == "__main__":
    # 测试用例：和当前库里那条"用户和朋友深夜活动"做对比
    new = "用户和朋友深夜活动后回家"
    cands = [
        {
            "pid": "15295351293916629378",
            "score": 0.891,
            "summary": "用户与朋友关系亲近，经常一起进行各类活动，即使后来异地也保持联系，平日一起进行看电视、散步、爬山等活动。",
            "state": "active",
        },
        {
            "pid": "9999999999",
            "score": 0.78,
            "summary": "用户喜欢逛超市和买零食，旅行中买零食会特别开心。",
            "state": "active",
        },
    ]
